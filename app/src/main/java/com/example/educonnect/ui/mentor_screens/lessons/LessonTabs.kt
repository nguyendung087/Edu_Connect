...
object LessonManageDestination : NavigationDestination {
    override val route = "lessons"
    override val titleRes = R.string.lesson_title
}
...
fun LessonTabs(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                "${uiState.value.lessons.size} " + if (uiState.value.lessons.size > 1) "Lessons" else "Lesson",
